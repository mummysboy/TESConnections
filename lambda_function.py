...
ALLOWED_ORIGINS = [
    ...
    'https://dmexco-connections.dbovg7p76124l.amplifyapp.com',
    'http://127.0.0.1:5500',
    'http://localhost:5500',
    'http://localhost:8000',
    'http://127.0.0.1:8000'
...
def get_cors_headers(origin):
    ...
    default_headers = {
        ...
        'Access-Control-Allow-Origin': 'https://dmexco-connections.dbovg7p76124l.amplifyapp.com',  # Default to DMEXCO Amplify URL
